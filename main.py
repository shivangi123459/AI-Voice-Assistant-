...
def main_process():
    ...
    while True:
        ...
        #     speak("Email sent")
            ...
            s.starttls()
            s.login("sender@xgmail.com", user_config.gmail_password)
            message = """
            This is the message.

            Thanks by Mohit Gupta.

            """
            s.sendmail("sender@xgmail.com", "receiver@xgmail.com", message)
            s.quit()
            speak("Email sent")
